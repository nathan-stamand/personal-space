<template>
  <header class="bg-black/70 overflow-visible fixed w-full h-auto left-0 top-0 z-50" id="page_header">
    <button 
      ...
      <span class="before:block before:absolute before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 
      before:w-5/12 before:h-0.5 before:bg-white before:rounded-md"></span>
      <span class="before:block before:absolute before:top-1/3 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 
      before:w-5/12 before:h-0.5 before:bg-white before:rounded-md"></span>
      <span class="before:block before:absolute before:top-2/3 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 
      before:w-5/12 before:h-0.5 before:bg-white before:rounded-md"></span>

    </button>

    <!-- Mobile Menu -->
    <nav v-show="showMenu" class="max-w-md text-right w-full bg-black h-screen mx-auto block lg:hidden absolute top-0 right-0" id="main-menu" role="menu">
      <button 
